...
export default function ContactPage() {
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <div className="text-xl font-bold text-primary">mureveonsysbusiness@gmail.com</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <div className="text-xl font-bold text-primary">+91 9967482172</div>
                  </div>
                </div>
  ...
  <input 
    ...
    className="w-full px-6 py-4 rounded-2xl bg-secondary/30 border border-transparent focus:bg-white focus:border-accent transition-all outline-none" 
  />
</div>
              </div>
